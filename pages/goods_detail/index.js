...
3 点击 加入购物车
  1 先绑定点击事件
  2 获取缓存中的购物者数据 数组格式
  3 先判断 当前的商品时候已经存在于 购物车
  4 已经存在 修改商品数据 执行购物车数量++ 重新吧购物车数组 填充到缓存中
  5 不存在与购物车的数组中 直接给购物车数组添加一个新元素 新元素 带上 购买数量属性 填充到缓存中
  6 弹出提示
4 页面收藏
  ...
  async getGoodsDetail(goods_id){
    ...
    this.setData({
      ...
      goodsObj:{
        ...
        goods_introduce:data.message.goods_introduce.replace(/\.webp/,'.jpg'),
